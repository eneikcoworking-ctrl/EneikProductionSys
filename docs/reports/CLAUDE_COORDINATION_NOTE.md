...
22. **Наставление $\mathcal{L}_2$: ядро и периферия по Куайну, и первый ядерный закон — приём требования.**
    ...
    **Чего не делать.** Не оборачивать внешние вызовы в try/catch внутри той же транзакции — это заплатка:
    она прячет отказ, но оставляет атомарность, охватывающую внешний мир. Разделять акты, а не глушить
    исключения.
