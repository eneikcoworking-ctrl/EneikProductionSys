...
## Отчёт
    ...
    механизм и образец → что сделано → что осталось открытым → фабрика одной строкой

Живое состояние — одна строка: числитель, застой, отказы, ошибки; без изменений — так и писать. Фабрика
выносится наверх **только** если она стоит или числитель двинулся. Шаги измерения обязательны к исполнению и
**не обязательны к пересказу**: замер, никого не удививший, места в отчёте не занимает.
