...
- **Чем проверено:**
  1. `TocSentinelServiceTest`:
     ...
     - `derivedCadenceWithoutObservationsRelaxesToMaxBound`: без наблюдений возвращается верхняя граница (10000 мс).
     ...
     - `derivedCadenceClampsToDeclaredMinAndMaxBounds`: зажим при выходе за нижний (250 мс) и верхний (5000 мс) пределы.
