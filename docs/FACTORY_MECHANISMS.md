...
**между собой** и рассогласованы **с системой**. Механизм считает это исправно и **никто по этому числу
ничего не делает**: порога нет, отказа нет, в свод оно не попадает.
