...
*Проверка 2026-09-06 06:41 — выборка мала, вывода нет.* За жизнь текущего контейнера (около 26 минут после
пересборки) таких строк **2**, обе в 06:17. Прежний залп шёл в 43 строки около :26–:30 каждого часа, и это
окно контейнер ещё не прожил. Утверждать «залп прекратился» нельзя. Порог для вывода: **два полных часа без
залпа**.
