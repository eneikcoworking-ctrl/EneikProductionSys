...
*Делать.* Развести два рода, а не растягивать окно:
1. **Постоянная выкладка клиента** — отдельный, всегда поднятый стек, не подчинённый тику наблюдения и не
   сносимый им. Это единственное, что отвечает на «должно быть видно на хостинге».
2. **Наблюдение оставить как есть.** Растягивание `live-preview-idle-minutes` до суток даёт видимый сайт
   ценой того, что инструмент перестаёт быть инструментом: он больше не меряет холодный старт, а меряет
   давно работающий процесс. Замер холодного старта — то, ради чего он существует.
3. **Снос обязан называть род.** Сейчас строка «live-preview window expired, torn down» верна и при этом
   читается как поломка хостинга. Она обязана говорить, что снесено **наблюдение**, а не выкладка.
...
Двадцать шесть пунктов, все со своим образцом, замером, заслоном и опровержением. Порядок работы задан
