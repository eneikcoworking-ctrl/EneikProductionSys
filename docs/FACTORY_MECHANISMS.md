...
**Полный знаменатель, перемерян 6 сентября — 522 единицы, записей 180. Слой миграций закрыт.**
...
исправлена на эту единицу.
    ...
    фронтенд (svelte)                                21        —  ИСКЛЮЧЁН ИЗ РАЗБОРА
      (указание оператора 7 сентября: будет переписан заново, разбирать нынешний — муда)
    скрипты                                          12        0
                                                   ----     ----
                                                    522      180
