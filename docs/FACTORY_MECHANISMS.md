...
Отказов «Screen rejected» — **8**. То есть отвергнуты **все восемь из восьми**.
...
Тридцать шесть пунктов, все со своим образцом, замером, заслоном и опровержением. Порядок работы задан
